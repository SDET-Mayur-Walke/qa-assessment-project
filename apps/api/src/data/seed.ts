import type { Product, User, Cart } from "shared";
...
export interface SeedData {
  ...
  orders: any[];
  loginCodes: Map<string, { code: string; createdAt: Date }>;
}
...
export function getFeatureFlag(name: string, headers: any, env = process.env): boolean {
...
export function getChaosValue(name: string, defaultValue: number, env = process.env): number {
